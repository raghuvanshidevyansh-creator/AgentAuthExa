...
export default function LandingPage({ config, basePath }: Props) {
      ...
      <section className="hero">
        <div className="w">
          ...
          <div className="ctas r" style={{ transitionDelay: '.3s' }}>
            <Link href={`${basePath}/thesis`} className="btn-s">Read the thesis</Link>
      ...
      <footer className="site-footer-landing">
        <div className="w">
          ...
          <div className="f-links">
            <Link href={`${basePath}/thesis`}>Read the thesis</Link>
          </div>
